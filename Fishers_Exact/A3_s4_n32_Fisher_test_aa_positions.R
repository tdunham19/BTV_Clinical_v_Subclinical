...
# read in protein MSA
fasta_file <- "A3_s4_n32_CDS_Only_protein_aln.fasta"
...
write.csv(aa_long, "A3_s4_n32_results_amino_acids_by_sample_and_position_013026.csv", row.names = FALSE)
...
# write output to csv
write.csv(results_df, "A3_s4_n32_results_fisher_exact_by_position_013026.csv", row.names = FALSE)
