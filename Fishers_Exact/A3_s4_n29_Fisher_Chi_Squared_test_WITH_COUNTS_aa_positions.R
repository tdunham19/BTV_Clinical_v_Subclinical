...
write.csv(aa_long, "A3_s4_n29_results_amino_acids_by_sample_and_position_071326_WITH_COUNTS.csv", row.names = FALSE)
...
# write output to csv
write.csv(results_df, "A3_s4_n29_results_fisher_exact_chi_squared_WITH_COUNTS_by_position_071326.csv", row.names = FALSE)
